...
"Estáis en El Concilio de Elrond (El señor de los Anillos), interpretad la mítica escena y, si lo hacéis, quedan anulados todos los castigos y normas que había hasta el momento, además brindaréis en honor a Tolkien.\n 'No es importante saber cuánto tiempo queda sino qué hacer con el tiempo que se nos ha dado - J.R.R. Tolkien'",
...
"Stan Lee, Tolkien, Freddie Mercury, Michael Jackson, Eduardo Gómez, está va por vosotros, un brindis, el mundo os echa de menos", 
"TODOS REPARTEN 2 TRAGOS",
"Silencio todo el mundo, comienza el juego de las bodas, todos podeis hacer una propuesta de matrimonio a otro jugador, este podrá aceptarla o no, si la rechaza deberás beber 5 tragos para ahogar las penas, si acepta debeis besaros (pico) y el resto beberá 10 tragos",
];
